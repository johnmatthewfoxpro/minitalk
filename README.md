...
Now in a second terminal in the same directory you can use ./client to run the client. The executable MUST be formated like "./client 'server pid' 'string message'"  
Example: ./client 0420 "Hello World"  
If all has gone well, you should see your message appear on the terminal window running the server!  
